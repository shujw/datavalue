...
const imartApiMall = 'https://demo.intra-mart.com.cn'

const getAccountList = (params) => wxRequest(params, imartApiMall + '/imart_demo/logic/api/sample/accounts');

const code2session = (params) => wxRequest(params, imartApiMall + '/imart_demo/logic/api/code2session');

const addOrUpdateWechatAccount = (params) => wxRequest(params, imartApiMall + '/imart_demo/logic/api/addOrUpdateWechatAccount');

const getHomeImageUrlList = (params) => wxRequest(params, imartApiMall + '/imart_demo/logic/api/getImageUrl');
